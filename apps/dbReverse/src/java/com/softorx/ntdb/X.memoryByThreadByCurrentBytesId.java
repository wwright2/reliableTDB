...
public class X.memoryByThreadByCurrentBytesId  implements java.io.Serializable {
    ...
    public X.memoryByThreadByCurrentBytesId(BigDecimal currentAvgAlloc, long threadId) {
        this.currentAvgAlloc = currentAvgAlloc;
        this.threadId = threadId;
    }
    public X.memoryByThreadByCurrentBytesId(BigInteger currentAllocated, BigDecimal currentAvgAlloc, BigInteger currentCountUsed, Long currentMaxAlloc, long threadId, BigInteger totalAllocated, String user) {
