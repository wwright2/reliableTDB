...
public class X.userSummaryByStatementLatencyId  implements java.io.Serializable {
    ...
    public X.userSummaryByStatementLatencyId(BigInteger cpuLatency, BigInteger fullScans, BigInteger lockLatency, BigInteger maxLatency, BigInteger rowsAffected, BigInteger rowsExamined, BigInteger rowsSent, BigInteger total, BigInteger totalLatency, String user) {
   ...
   public boolean equals(Object other) {
		 ...
		 return ( (this.getCpuLatency()==castOther.getCpuLatency()) || ( this.getCpuLatency()!=null && castOther.getCpuLatency()!=null && this.getCpuLatency().equals(castOther.getCpuLatency()) ) )
