...
public class X.schemaTableStatisticsWithBufferId  implements java.io.Serializable {
    ...
    public X.schemaTableStatisticsWithBufferId(long deleteLatency, long fetchLatency, long insertLatency, long rowsDeleted, long rowsFetched, long rowsInserted, long rowsUpdated, long updateLatency) {
    ...
    public X.schemaTableStatisticsWithBufferId(long deleteLatency, long fetchLatency, BigInteger innodbBufferAllocated, BigInteger innodbBufferData, BigInteger innodbBufferFree, Long innodbBufferPages, Long innodbBufferPagesHashed, Long innodbBufferPagesOld, BigInteger innodbBufferRowsCached, long insertLatency, BigInteger ioMiscLatency, BigInteger ioMiscRequests, BigInteger ioRead, BigInteger ioReadLatency, BigInteger ioReadRequests, BigInteger ioWrite, BigInteger ioWriteLatency, BigInteger ioWriteRequests, long rowsDeleted, long rowsFetched, long rowsInserted, long rowsUpdated, String tableName, String tableSchema, long updateLatency) {
       this.deleteLatency = deleteLatency;
       this.fetchLatency = fetchLatency;
