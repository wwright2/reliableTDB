...
public class X.statementsWithTempTablesId  implements java.io.Serializable {
    ...
    public X.statementsWithTempTablesId(BigInteger avgTmpTablesPerQuery, long diskTmpTables, long execCount, Timestamp firstSeen, Timestamp lastSeen, long memoryTmpTables, BigInteger tmpTablesToDiskPct, long totalLatency) {
    ...
    public X.statementsWithTempTablesId(BigInteger avgTmpTablesPerQuery, String db, String digest, long diskTmpTables, long execCount, Timestamp firstSeen, Timestamp lastSeen, long memoryTmpTables, String query, BigInteger tmpTablesToDiskPct, long totalLatency) {
       this.avgTmpTablesPerQuery = avgTmpTablesPerQuery;
       this.db = db;
       this.digest = digest;
       this.diskTmpTables = diskTmpTables;
   ...
   public boolean equals(Object other) {
		 ...
		 return ( (this.getAvgTmpTablesPerQuery()==castOther.getAvgTmpTablesPerQuery()) || ( this.getAvgTmpTablesPerQuery()!=null && castOther.getAvgTmpTablesPerQuery()!=null && this.getAvgTmpTablesPerQuery().equals(castOther.getAvgTmpTablesPerQuery()) ) )
