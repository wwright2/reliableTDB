...
public class StatementsWithSortingId implements java.io.Serializable {
	...
	public StatementsWithSortingId(BigInteger avgRowsSorted, BigInteger avgSortMerges, long execCount,
			Timestamp firstSeen, Timestamp lastSeen, long rowsSorted, long sortMergePasses, long sortUsingRange,
			long sortsUsingScans) {
	...
	public StatementsWithSortingId(BigInteger avgRowsSorted, BigInteger avgSortMerges, String db, String digest,
			long execCount, Timestamp firstSeen, Timestamp lastSeen, String query, long rowsSorted,
			long sortMergePasses, long sortUsingRange, long sortsUsingScans, String totalLatency) {
		this.avgRowsSorted = avgRowsSorted;
		this.avgSortMerges = avgSortMerges;
		this.db = db;
		this.digest = digest;
	...
	public boolean equals(Object other) {
		...
		return ((this.getAvgRowsSorted() == castOther.getAvgRowsSorted())
