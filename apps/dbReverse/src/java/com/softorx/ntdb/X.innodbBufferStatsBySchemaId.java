...
public class X.innodbBufferStatsBySchemaId  implements java.io.Serializable {
    ...
    public X.innodbBufferStatsBySchemaId(BigInteger allocated, BigInteger data, String objectSchema, long pages, long pagesHashed, long pagesOld, BigInteger rowsCached) {
