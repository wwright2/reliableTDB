...
public class X.userSummaryId  implements java.io.Serializable {
    ...
    public X.userSummaryId(BigInteger currentConnections, BigInteger currentMemory, BigInteger fileIoLatency, BigInteger fileIos, BigDecimal statementAvgLatency, BigInteger statementLatency, BigInteger statements, BigInteger tableScans, BigInteger totalConnections, BigInteger totalMemoryAllocated, long uniqueHosts, String user) {
