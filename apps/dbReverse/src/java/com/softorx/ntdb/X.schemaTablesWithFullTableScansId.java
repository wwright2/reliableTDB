...
public class X.schemaTablesWithFullTableScansId  implements java.io.Serializable {
    ...
    public X.schemaTablesWithFullTableScansId(long latency, long rowsFullScanned) {
        this.latency = latency;
        this.rowsFullScanned = rowsFullScanned;
    }
    public X.schemaTablesWithFullTableScansId(long latency, String objectName, String objectSchema, long rowsFullScanned) {
       this.latency = latency;
   ...
   public boolean equals(Object other) {
		 ...
		 return (this.getLatency()==castOther.getLatency())
