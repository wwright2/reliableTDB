...
public class LatestFileIoId implements java.io.Serializable {
	...
	public LatestFileIoId(String file, String latency, String operation, String requested, String thread) {
		this.file = file;
	...
	public boolean equals(Object other) {
		...
		return ((this.getFile() == castOther.getFile()) || (this.getFile() != null && castOther.getFile() != null
				...
				&& ((this.getThread() == castOther.getThread()) || (this.getThread() != null
