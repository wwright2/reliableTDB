...
public class ProcesslistId implements java.io.Serializable {
	...
	public ProcesslistId(String fullScan, long thdId) {
		this.fullScan = fullScan;
		this.thdId = thdId;
	}

	public ProcesslistId(String command, Long connId, String cpuLatency, String currentMemory, String currentStatement,
			String db, String executionEngine, String fullScan, String lastStatement, String lastStatementLatency,
			String lastWait, String lastWaitLatency, String lockLatency, String pid, String programName,
			BigDecimal progress, Long rowsAffected, Long rowsExamined, Long rowsSent, String source, String state,
			String statementLatency, long thdId, Long time, Long tmpDiskTables, Long tmpTables, String trxAutocommit,
			String trxLatency, String trxState, String user) {
	...
	public boolean equals(Object other) {
		...
		return ((this.getCommand() == castOther.getCommand()) || (this.getCommand() != null
