...
public class StatementsWithFullTableScansId implements java.io.Serializable {
	...
	public StatementsWithFullTableScansId(long execCount, Timestamp firstSeen, Timestamp lastSeen,
			long noGoodIndexUsedCount, long noIndexUsedCount, BigInteger noIndexUsedPct, long rowsExamined,
			long rowsSent) {
	...
	public StatementsWithFullTableScansId(String db, String digest, long execCount, Timestamp firstSeen,
			Timestamp lastSeen, long noGoodIndexUsedCount, long noIndexUsedCount, BigInteger noIndexUsedPct,
			String query, long rowsExamined, BigInteger rowsExaminedAvg, long rowsSent, BigInteger rowsSentAvg,
			String totalLatency) {
		this.db = db;
		this.digest = digest;
		this.execCount = execCount;
