...
public class X.ioByThreadByLatencyId  implements java.io.Serializable {
    ...
    public X.ioByThreadByLatencyId(BigDecimal avgLatency, Long maxLatency, Long minLatency, Long processlistId, long threadId, BigInteger total, BigInteger totalLatency, String user) {
