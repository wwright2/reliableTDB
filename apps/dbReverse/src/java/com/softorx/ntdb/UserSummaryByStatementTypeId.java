...
public class UserSummaryByStatementTypeId implements java.io.Serializable {
	...
	public UserSummaryByStatementTypeId(long fullScans, long rowsAffected, long rowsExamined, long rowsSent,
			long total) {
	...
	public UserSummaryByStatementTypeId(String cpuLatency, long fullScans, String lockLatency, String maxLatency,
			long rowsAffected, long rowsExamined, long rowsSent, String statement, long total, String totalLatency,
			String user) {
