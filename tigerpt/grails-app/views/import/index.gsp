...
<body>
    <h1>Import Trauma Registry XML</h1>
    ...
    <div class="card">
        <div class="card-body">
            <h5>Upload  Sample XML File</h5>
            <p>Select an  trauma registry XML file (e.g., Sample.xml) to import patient and injury data.</p>
    ...
    <div class="mt-4">
        <h5>XML Format</h5>
        <p>The system expects Trauma Registry XML format with the following structure:</p>
        <pre>&lt;ITRRecords&gt;
  &lt;ITRRecord&gt;
    &lt;PatientId&gt;...&lt;/PatientId&gt;
